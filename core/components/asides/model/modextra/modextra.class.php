...
class Asides {
    ...
    public function initialize($ctx = 'web') {
        switch ($ctx) {
            case 'mgr':
                if (!$this->modx->loadClass('asides.request.modExtraControllerRequest',$this->config['modelPath'],true,true)) {
            ...
            break;
            case 'connector':
                if (!$this->modx->loadClass('asides.request.modExtraConnectorRequest',$this->config['modelPath'],true,true)) {
            ...
            default:
                 ...
                 * call $asides->initialize($modx->context->get('key'));
